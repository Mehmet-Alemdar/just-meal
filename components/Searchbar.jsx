    ...
    <>
      {
        ...
        <div className="w-full h-28 bg-black/80 absolute z-10 flex justify-center items-center">
          <div class="relative md:w-1/2 w-11/12">
            <form className="w-full">
              ...
              <Link href={`/search/${searchText}`}>
                <button id="search-button" type="submit" class="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-myellow rounded-r-lg border border-myellow hover:bg-amber-500" onClick={handleSearch}>
